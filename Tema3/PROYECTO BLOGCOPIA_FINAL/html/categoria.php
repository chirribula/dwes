       ...
       <div id="contenido">
            <div id="titulos">               
                <?php
                    ...
                    $sql2="SELECT nombre FROM categorias WHERE id=$id_categoria";
                    $result2=mysqli_query($conexion,$sql2);
                    $result=mysqli_query($conexion,$sql);                                          
                    $fila2 = mysqli_fetch_assoc($result2);      //con esto consigo que me cambie el título de la categoría dinamicamente
                ...
                ?>  
                    <span class="titulo"><?=$fila2['nombre']?></span>
