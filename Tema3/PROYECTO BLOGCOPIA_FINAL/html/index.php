       ...
       <div id="contenido">
           ...
           <div id="entradas">
                ...
                <?php
                     ...
                     if($buscar != ""){               
                            $sql="SELECT e.titulo,e.id, e.descripcion, c.nombre,e.fecha FROM entradas e, categorias c WHERE e.categoria_id=c.id  AND  e.titulo like '%$buscar%' ORDER BY e.fecha ASC";           
                ...
                <?php         
                      ...
                      $sql="SELECT e.titulo, e.descripcion,e.id, c.nombre,e.fecha FROM entradas e, categorias c WHERE e.categoria_id=c.id ORDER BY e.fecha ASC ";  
                      $result = mysqli_query($conexion,$sql);
